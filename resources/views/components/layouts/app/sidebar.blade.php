        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:navlist.item icon="clipboard-document-list" :href="route('orders.index')" :current="request()->routeIs('orders.*')" wire:navigate>{{ __('Pedidos') }}</flux:navlist.item>
                    <flux:navlist.item icon="chart-bar" :href="route('reports.products-sales')" :current="request()->routeIs('reports.*')" wire:navigate>{{ __('Reportes') }}</flux:navlist.item>
                </flux:navlist.group>
                ...
                <flux:navlist.group :heading="__('Administration')" class="grid">
                    ...
                    <flux:navlist.item icon="users" :href="route('employees.index')" :current="request()->routeIs('employees.index')" wire:navigate>{{ __('Integrantes') }}</flux:navlist.item>
                    <flux:navlist.item icon="archive-box" :href="route('employees.inactivos')" :current="request()->routeIs('employees.inactivos')" wire:navigate>{{ __('Histórico') }}</flux:navlist.item>
                </flux:navlist.group>
